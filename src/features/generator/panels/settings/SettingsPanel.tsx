    ...
    <div className="flex h-full flex-col bg-background-generator border border-background-2 rounded-xl">
      <div className="flex flex-wrap items-center justify-between gap-3 px-4 pt-3 text-center sm:flex-nowrap sm:px-6 sm:pt-4 sm:text-left pb-0">
        ...
        <motion.button
          ...
          onClick={onClose}
          className={cn(
            "flex h-9 w-9 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-background-2/40 hover:text-foreground cursor-pointer",
            FOCUS_RING_CLASSES
          )}
          aria-label={t("close")}
          title={t("close")}
