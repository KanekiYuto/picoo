...
export function VisibilityField({}: VisibilityFieldProps) {
  ...
  return (
    <div className="rounded-2xl border border-background-2 bg-background-generator px-3 py-3 sm:px-4 sm:py-3.5">
      <div className="flex items-center justify-between gap-3">
        <p className="text-sm font-medium text-foreground">{t("visibility")}</p>
        <FormControl>
          <div className="relative flex gap-1 rounded-lg bg-background-1 border border-background-2 p-1">
              ...
              >
                {field.value === option && (
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-md bg-background-generator border border-background-2"
