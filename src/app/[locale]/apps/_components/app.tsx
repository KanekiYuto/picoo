...
export function App({ title, description, form, previewMedia }: AppProps) {
    ...
    return (
        <section className="grid w-full grid-cols-1 gap-12 rounded-lg border border-background-2 bg-background-1/40 p-6 text-foreground sm:gap-12 md:grid-cols-[1fr_1.15fr] md:gap-16 md:p-10">
