        ...
        >
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              >
                <span className="relative z-10">{t('buttons.primary')}</span>
              ...
              >
                <span className="relative z-10">{t('buttons.secondary')}</span>
              </Link>
            </div>

            {/* 底部提示 */}
            <div className="mt-6 sm:mt-8 flex items-center justify-center gap-2 text-sm text-muted-foreground">
              <svg className="w-4 h-4 flex-shrink-0 text-[#ff3466]" fill="currentColor" viewBox="0 0 20 20">
