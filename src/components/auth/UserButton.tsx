            ...
            >
              ...
              <div className="p-3 border-b border-border">
                ...
                <Link
                  href="/settings/team"
                  onClick={closeMenu}
                  className="flex items-center gap-3 p-2 rounded-lg hover:bg-sidebar-hover transition-colors group"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-muted">
                      {t("teamMembers", { count: currentTeam.memberCount })}
                    </div>
                  </div>
                </Link>
                ...
                <Link
                  href="/settings/profile"
                  onClick={closeMenu}
                  className="flex items-center gap-3 p-2 rounded-lg hover:bg-sidebar-hover transition-colors group mt-1"
                >
                ...
                <button className="w-full flex items-center gap-2 p-2 mt-2 rounded-lg hover:bg-sidebar-hover transition-colors text-primary text-sm font-medium">
